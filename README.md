...
| **粒子模型** | XPBD 距离约束 + bend 约束 + 硬锚，540 粒子 / 1926 约束 |
...
# 远程机起 web viewer（监听所有网卡，方便从外部访问）
python3 cli.py view-rerun /tmp/vis_dataset/raw --serve --bind 0.0.0.0:9090
# 浏览器打开 http://<host>:9090
```
